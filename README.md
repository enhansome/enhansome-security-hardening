...
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 30,292 | 🐛 34 | 📅 2026-07-13 - for a single Linux server at home
* [trimstray - The Practical Linux Hardening Guide](https://github.com/trimstray/the-practical-linux-hardening-guide) ⭐ 10,813 | 🐛 10 | 📅 2024-11-19 - practical step-by-step instructions for building your own hardened systems and services. Tested on CentOS 7 and RHEL 7.
* [Neo23x0/auditd](https://github.com/Neo23x0/auditd) ⭐ 1,889 | 🐛 18 | 🌐 Shell | 📅 2026-05-04 - Best Practice Auditd Configuration
* [trimstray - Linux Hardening Checklist](https://github.com/trimstray/linux-hardening-checklist) ⭐ 1,644 | 🐛 5 | 📅 2024-11-19 - most important hardening rules for GNU/Linux systems (summarized version of The Practical Linux Hardening Guide)
...
* [Awesome Windows Domain Hardening](https://github.com/PaulSec/awesome-windows-domain-hardening) ⭐ 1,796 | 🐛 1 | 📅 2020-01-07
* [NSA - Event Forwarding Guidance](https://github.com/nsacyber/Event-Forwarding-Guidance) ⭐ 890 | 🐛 8 | 🌐 PowerShell | 📅 2020-11-17 - Configuration guidance for implementing collection of security relevant Windows Event Log events by using Windows Event Forwarding
* [NSA - AppLocker Guidance](https://github.com/nsacyber/AppLocker-Guidance) ⭐ 244 | 🐛 1 | 🌐 PowerShell | 📅 2025-10-31 - Configuration guidance for implementing application whitelisting with AppLocker
* [NSA - Pass the Hash Guidance](https://github.com/nsacyber/Pass-the-Hash-Guidance) ⚠️ Archived - Configuration guidance for implementing Pass-the-Hash mitigations (Archived)
* [NSA - BitLocker Guidance](https://github.com/nsacyber/BitLocker-Guidance) ⚠️ Archived - Configuration guidance for implementing disk encryption with BitLocker
...
* [Qualys SSL Labs - SSL and TLS Deployment Best Practices](https://github.com/ssllabs/research/wiki/SSL-and-TLS-Deployment-Best-Practices) ⭐ 2,206 | 🐛 2 | 📅 2023-03-14 - 2017, does not cover TLS 1.3
...
* [VPS Security Audit Script](https://github.com/vernu/vps-audit) ⭐ 2,526 | 🐛 10 | 🌐 Shell | 📅 2026-08-10 - A comprehensive Bash script for auditing the security and performance of your VPS (Virtual Private Server)
...
* [CIS Debian Hardening](https://github.com/ovh/debian-cis) ⭐ 1,051 | 🐛 18 | 🌐 Shell | 📅 2026-08-17 - Modular Debian 11/12/13 security hardening scripts based on [CIS Benchmarks](https://www.cisecurity.org/cis-benchmarks/) recommendations.
...
* [CIS Benchmarks Audit](https://github.com/finalduty/cis_benchmarks_audit) ⭐ 276 | 🐛 9 | 🌐 Python | 📅 2024-05-03 - bash script which performs tests against your CentOS system to give an indication of whether the running server may comply with the CIS v2.2.0 Benchmarks for CentOS (only CentOS 7 for now)
...
* [HardeningAuditor](https://github.com/cottinghamd/HardeningAuditor/) ⭐ 159 | 🐛 0 | 🌐 PowerShell | 📅 2019-12-20 - Scripts for comparing Microsoft Windows compliance with the Australian ASD 1709 & Office 2016 Hardening Guides
* [MDE-AuditCheck](https://github.com/olafhartong/MDE-AuditCheck) ⭐ 101 | 🐛 1 | 🌐 PowerShell | 📅 2022-07-15 - Tool to check that Windows audit settings are properly configured in the GPO for Microsoft Defender for Endpoint
...
* [Nipper-ng](https://github.com/arpitn30/nipper-ng) ⭐ 78 | 🐛 1 | 🌐 C++ | 📅 2022-06-28 - to check the configuration of network devices (does not seem to be updated)

### TLS/SSL

* [testssl.sh](https://github.com/drwetter/testssl.sh) ⭐ 9,173 | 🐛 250 | 🌐 Shell | 📅 2026-08-15 - Testing TLS/SSL encryption anywhere on any port
* [SSLyze](https://github.com/nabla-c0d3/sslyze) ⭐ 3,773 | 🐛 30 | 🌐 Python | 📅 2026-07-29 - Fast and powerful SSL/TLS scanning library.
* [Qualys SSL Labs - List of tools to assess TLS/SSL servers and clients](https://github.com/ssllabs/research/wiki/Assessment-Tools) ⭐ 2,206 | 🐛 2 | 📅 2023-03-14
* [CryptoLyzer](https://github.com/c0r0n3r/cryptolyzer) ⭐ 48 | 🐛 0 | 🌐 Python | 📅 2026-07-31 - Fast, flexible and comprehensive server cryptographic protocol (TLS, SSL, SSH, DNSSEC) and related setting (HTTP headers, DNS records) analyzer and fingerprint (JA3, HASSH tag) generator with Python API and CLI.

### SSH

* [ssh-audit](https://github.com/arthepsy/ssh-audit) ⭐ 2,995 | 🐛 31 | 🌐 Python | 📅 2024-06-28 - SSH server auditing (banner, key exchange, encryption, mac, compression, compatibility, security, etc)
* [CryptoLyzer](https://github.com/c0r0n3r/cryptolyzer) ⭐ 48 | 🐛 0 | 🌐 Python | 📅 2026-07-31 - Fast, flexible and comprehensive server cryptographic protocol (TLS, SSL, SSH, DNSSEC) and related setting (HTTP headers, DNS records) analyzer and fingerprint (JA3, HASSH tag) generator with Python API and CLI.

### Hardware - CPU - BIOS - UEFI

* [CHIPSEC: Platform Security Assessment Framework](https://github.com/chipsec/chipsec) ⭐ 3,297 | 🐛 55 | 🌐 Python | 📅 2026-08-18 - framework for analyzing the security of PC platforms including hardware, system firmware (BIOS/UEFI), and platform components
...
* [Docker Bench for Security](https://github.com/docker/docker-bench-security) ⭐ 9,692 | 🐛 29 | 🌐 Shell | 📅 2026-06-04 - script that checks for dozens of common best-practices around deploying Docker containers in production, inspired by the CIS Docker Community Edition Benchmark v1.1.0.

### Cloud

* [toniblyx/my-arsenal-of-aws-security-tools](https://github.com/toniblyx/my-arsenal-of-aws-security-tools) ⭐ 9,499 | 🐛 10 | 🌐 Shell | 📅 2026-07-07 - List of open source tools for AWS security: defensive, offensive, auditing, DFIR, etc.
...
* [Linux Server Hardener](https://github.com/pratiktri/server_init_harden) ⭐ 117 | 🐛 0 | 🌐 Shell | 📅 2025-10-14 - for Debian/Ubuntu (2019)
...
* [Hardentools](https://github.com/securitywithoutborders/hardentools) ⭐ 3,105 | 🐛 12 | 🌐 Go | 📅 2025-08-10 - for Windows individual users (not corporate environments) at risk, who might want an extra level of security at the price of some usability.
...
* [Windows 10/11 Hardening Script by ZephrFish](https://github.com/ZephrFish/WindowsHardeningScript) ⭐ 137 | 🐛 0 | 🌐 Batchfile | 📅 2026-07-30 - PowerShell script to harden Windows 10/11
* [Microsoft Security Compliance Toolkit 1.0](https://docs.microsoft.com/en-us/windows/security/threat-protection/security-compliance-toolkit-10) - set of tools that allows enterprise security administrators to download, analyze, test, edit, and store Microsoft-recommended security configuration baselines for Windows and other Microsoft products
* [mackwage/windows\_hardening.cmd](https://gist.github.com/mackwage/08604751462126599d7e52f233490efe) - Script to perform some hardening of Windows 10
...
* [Awesome Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,521 | 🐛 74 | 📅 2024-07-15 - A curated collection of awesome resources, tools, and other shiny things for cybersecurity blue teams.

## Other Awesome Security Lists

(borrowed from [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,765 | 🐛 309 | 📅 2026-01-11)

* [Awesome Pentest](https://github.com/enaqx/awesome-pentest) ⭐ 26,935 | 🐛 99 | 📅 2026-07-25 - A collection of awesome penetration testing resources, tools and other shiny things.
* [Awesome Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 16,897 | 🐛 68 | 📅 2024-06-02 - A curated list of awesome Hacking tutorials, tools and resources.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,765 | 🐛 309 | 📅 2026-01-11 - A collection of awesome software, libraries, documents, books, resources and cools stuffs about security.
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,133 | 🐛 25 | 📅 2024-06-07 - A curated list of awesome malware analysis tools and resources.
* [Awesome CTF](https://github.com/apsdehal/awesome-ctf) ⭐ 11,765 | 🐛 64 | 🌐 JavaScript | 📅 2024-07-22 - A curated list of CTF frameworks, libraries, resources and software.
* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,545 | 🐛 117 | 📅 2026-05-31 - A curated list of threat intelligence resources.
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,522 | 🐛 21 | 🌐 Python | 📅 2026-06-01 - An awesome list of honeypot resources.
...
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,335 | 🐛 74 | 📅 2026-07-15 - A curated list of resources for incident response.
* [Awesome Web Hacking](https://github.com/infoslack/awesome-web-hacking) ⭐ 7,236 | 🐛 7 | 📅 2026-08-13 - This list is for anyone wishing to learn about web application security but do not have a starting point.
* [Awesome Threat Detection and Hunting](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,702 | 🐛 54 | 📅 2026-01-05 - A curated list of awesome threat detection and hunting resources.
* [Awesome Cyber Skills](https://github.com/joe-shenouda/awesome-cyber-skills) ⭐ 4,624 | 🐛 8 | 📅 2024-07-02 - A curated list of hacking environments where you can train your cyber skills legally and safely.
...
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,257 | 🐛 1 | 📅 2026-06-15 - A curated list of awesome YARA rules, tools, and people.
* [Awesome PCAP Tools](https://github.com/caesar0301/awesome-pcaptools) ⭐ 3,414 | 🐛 14 | 📅 2025-09-03 - A collection of tools developed by other researchers in the Computer Science area to process network traces.

...
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 31,453 | 🐛 32 | 📅 2026-09-07 - for a single Linux server at home
* [trimstray - The Practical Linux Hardening Guide](https://github.com/trimstray/the-practical-linux-hardening-guide) ⭐ 10,841 | 🐛 10 | 📅 2024-11-19 - practical step-by-step instructions for building your own hardened systems and services. Tested on CentOS 7 and RHEL 7.
* [Neo23x0/auditd](https://github.com/Neo23x0/auditd) ⭐ 1,943 | 🐛 19 | 🌐 Shell | 📅 2026-05-04 - Best Practice Auditd Configuration
...
* [Awesome Windows Domain Hardening](https://github.com/PaulSec/awesome-windows-domain-hardening) ⭐ 1,802 | 🐛 1 | 📅 2020-01-07
...
* [VPS Security Audit Script](https://github.com/vernu/vps-audit) ⭐ 3,129 | 🐛 12 | 🌐 Shell | 📅 2026-08-10 - A comprehensive Bash script for auditing the security and performance of your VPS (Virtual Private Server)
...
* [testssl.sh](https://github.com/drwetter/testssl.sh) ⭐ 9,204 | 🐛 250 | 🌐 Shell | 📅 2026-09-20 - Testing TLS/SSL encryption anywhere on any port
...
* [CHIPSEC: Platform Security Assessment Framework](https://github.com/chipsec/chipsec) ⭐ 3,303 | 🐛 43 | 🌐 Python | 📅 2026-09-21 - framework for analyzing the security of PC platforms including hardware, system firmware (BIOS/UEFI), and platform components
...
* [Docker Bench for Security](https://github.com/docker/docker-bench-security) ⭐ 9,698 | 🐛 28 | 🌐 Shell | 📅 2026-06-04 - script that checks for dozens of common best-practices around deploying Docker containers in production, inspired by the CIS Docker Community Edition Benchmark v1.1.0.
...
* [Awesome Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,570 | 🐛 82 | 📅 2024-07-15 - A curated collection of awesome resources, tools, and other shiny things for cybersecurity blue teams.

## Other Awesome Security Lists

(borrowed from [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,873 | 🐛 338 | 📅 2026-01-11)

* [Awesome Pentest](https://github.com/enaqx/awesome-pentest) ⭐ 27,251 | 🐛 122 | 📅 2026-07-25 - A collection of awesome penetration testing resources, tools and other shiny things.
* [Awesome Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 17,107 | 🐛 73 | 📅 2024-06-02 - A curated list of awesome Hacking tutorials, tools and resources.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,873 | 🐛 338 | 📅 2026-01-11 - A collection of awesome software, libraries, documents, books, resources and cools stuffs about security.
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,209 | 🐛 25 | 📅 2024-06-07 - A curated list of awesome malware analysis tools and resources.
* [Awesome CTF](https://github.com/apsdehal/awesome-ctf) ⭐ 11,861 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22 - A curated list of CTF frameworks, libraries, resources and software.
* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,663 | 🐛 139 | 📅 2026-05-31 - A curated list of threat intelligence resources.
...
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,401 | 🐛 84 | 📅 2026-07-15 - A curated list of resources for incident response.
* [Awesome Web Hacking](https://github.com/infoslack/awesome-web-hacking) ⭐ 7,272 | 🐛 8 | 📅 2026-09-18 - This list is for anyone wishing to learn about web application security but do not have a starting point.
* [Awesome Threat Detection and Hunting](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,728 | 🐛 59 | 📅 2026-01-05 - A curated list of awesome threat detection and hunting resources.
* [Awesome Cyber Skills](https://github.com/joe-shenouda/awesome-cyber-skills) ⭐ 4,686 | 🐛 0 | 📅 2026-09-17 - A curated list of hacking environments where you can train your cyber skills legally and safely.
...
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,274 | 🐛 1 | 📅 2026-06-15 - A curated list of awesome YARA rules, tools, and people.

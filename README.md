...
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 31,455 | 🐛 32 | 📅 2026-09-07 - for a single Linux server at home
...
* [VPS Security Audit Script](https://github.com/vernu/vps-audit) ⭐ 3,130 | 🐛 12 | 🌐 Shell | 📅 2026-08-10 - A comprehensive Bash script for auditing the security and performance of your VPS (Virtual Private Server)
...
* [testssl.sh](https://github.com/drwetter/testssl.sh) ⭐ 9,205 | 🐛 249 | 🌐 Shell | 📅 2026-09-22 - Testing TLS/SSL encryption anywhere on any port
...
* [Docker Bench for Security](https://github.com/docker/docker-bench-security) ⭐ 9,699 | 🐛 28 | 🌐 Shell | 📅 2026-06-04 - script that checks for dozens of common best-practices around deploying Docker containers in production, inspired by the CIS Docker Community Edition Benchmark v1.1.0.
...
* [Awesome Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,574 | 🐛 82 | 📅 2024-07-15 - A curated collection of awesome resources, tools, and other shiny things for cybersecurity blue teams.

## Other Awesome Security Lists

(borrowed from [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,878 | 🐛 339 | 📅 2026-01-11)
...
* [Awesome Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 17,111 | 🐛 74 | 📅 2024-06-02 - A curated list of awesome Hacking tutorials, tools and resources.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,878 | 🐛 339 | 📅 2026-01-11 - A collection of awesome software, libraries, documents, books, resources and cools stuffs about security.
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,211 | 🐛 25 | 📅 2024-06-07 - A curated list of awesome malware analysis tools and resources.
...
* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,665 | 🐛 139 | 📅 2026-05-31 - A curated list of threat intelligence resources.
...
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,401 | 🐛 82 | 📅 2026-07-15 - A curated list of resources for incident response.
* [Awesome Web Hacking](https://github.com/infoslack/awesome-web-hacking) ⭐ 7,273 | 🐛 9 | 📅 2026-09-18 - This list is for anyone wishing to learn about web application security but do not have a starting point.
* [Awesome Threat Detection and Hunting](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,729 | 🐛 60 | 📅 2026-01-05 - A curated list of awesome threat detection and hunting resources.

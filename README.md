...
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 31,208 | 🐛 35 | 📅 2026-09-03 - for a single Linux server at home
...
* [VPS Security Audit Script](https://github.com/vernu/vps-audit) ⭐ 3,020 | 🐛 11 | 🌐 Shell | 📅 2026-08-10 - A comprehensive Bash script for auditing the security and performance of your VPS (Virtual Private Server)
...
* [CIS Debian Hardening](https://github.com/ovh/debian-cis) ⭐ 1,060 | 🐛 14 | 🌐 Shell | 📅 2026-09-04 - Modular Debian 11/12/13 security hardening scripts based on [CIS Benchmarks](https://www.cisecurity.org/cis-benchmarks/) recommendations.
...
* [testssl.sh](https://github.com/drwetter/testssl.sh) ⭐ 9,193 | 🐛 245 | 🌐 Shell | 📅 2026-09-03 - Testing TLS/SSL encryption anywhere on any port
* [SSLyze](https://github.com/nabla-c0d3/sslyze) ⭐ 3,774 | 🐛 31 | 🌐 Python | 📅 2026-08-30 - Fast and powerful SSL/TLS scanning library.
...
* [Awesome Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,555 | 🐛 79 | 📅 2024-07-15 - A curated collection of awesome resources, tools, and other shiny things for cybersecurity blue teams.

## Other Awesome Security Lists

(borrowed from [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,827 | 🐛 323 | 📅 2026-01-11)

* [Awesome Pentest](https://github.com/enaqx/awesome-pentest) ⭐ 27,112 | 🐛 111 | 📅 2026-07-25 - A collection of awesome penetration testing resources, tools and other shiny things.
* [Awesome Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 17,003 | 🐛 70 | 📅 2024-06-02 - A curated list of awesome Hacking tutorials, tools and resources.
...
* [Awesome CTF](https://github.com/apsdehal/awesome-ctf) ⭐ 11,824 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22 - A curated list of CTF frameworks, libraries, resources and software.
* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,593 | 🐛 121 | 📅 2026-05-31 - A curated list of threat intelligence resources.
...
* [Awesome Web Hacking](https://github.com/infoslack/awesome-web-hacking) ⭐ 7,258 | 🐛 9 | 📅 2026-09-04 - This list is for anyone wishing to learn about web application security but do not have a starting point.
* [Awesome Threat Detection and Hunting](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,721 | 🐛 54 | 📅 2026-01-05 - A curated list of awesome threat detection and hunting resources.

...
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 30,305 | 🐛 34 | 📅 2026-07-13 - for a single Linux server at home
* [trimstray - The Practical Linux Hardening Guide](https://github.com/trimstray/the-practical-linux-hardening-guide) ⭐ 10,817 | 🐛 10 | 📅 2024-11-19 - practical step-by-step instructions for building your own hardened systems and services. Tested on CentOS 7 and RHEL 7.
* [Neo23x0/auditd](https://github.com/Neo23x0/auditd) ⭐ 1,894 | 🐛 18 | 🌐 Shell | 📅 2026-05-04 - Best Practice Auditd Configuration
...
* [testssl.sh](https://github.com/drwetter/testssl.sh) ⭐ 9,179 | 🐛 252 | 🌐 Shell | 📅 2026-08-15 - Testing TLS/SSL encryption anywhere on any port
* [SSLyze](https://github.com/nabla-c0d3/sslyze) ⭐ 3,774 | 🐛 30 | 🌐 Python | 📅 2026-07-29 - Fast and powerful SSL/TLS scanning library.
...
* [CHIPSEC: Platform Security Assessment Framework](https://github.com/chipsec/chipsec) ⭐ 3,294 | 🐛 51 | 🌐 Python | 📅 2026-08-22 - framework for analyzing the security of PC platforms including hardware, system firmware (BIOS/UEFI), and platform components
...
* [Awesome Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,531 | 🐛 76 | 📅 2024-07-15 - A curated collection of awesome resources, tools, and other shiny things for cybersecurity blue teams.

## Other Awesome Security Lists

(borrowed from [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,788 | 🐛 313 | 📅 2026-01-11)

* [Awesome Pentest](https://github.com/enaqx/awesome-pentest) ⭐ 26,986 | 🐛 102 | 📅 2026-07-25 - A collection of awesome penetration testing resources, tools and other shiny things.
* [Awesome Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 16,922 | 🐛 69 | 📅 2024-06-02 - A curated list of awesome Hacking tutorials, tools and resources.
...
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,149 | 🐛 25 | 📅 2024-06-07 - A curated list of awesome malware analysis tools and resources.
* [Awesome CTF](https://github.com/apsdehal/awesome-ctf) ⭐ 11,783 | 🐛 65 | 🌐 JavaScript | 📅 2024-07-22 - A curated list of CTF frameworks, libraries, resources and software.
* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,562 | 🐛 117 | 📅 2026-05-31 - A curated list of threat intelligence resources.
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,528 | 🐛 22 | 🌐 Python | 📅 2026-06-01 - An awesome list of honeypot resources.
...
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,346 | 🐛 74 | 📅 2026-07-15 - A curated list of resources for incident response.
* [Awesome Web Hacking](https://github.com/infoslack/awesome-web-hacking) ⭐ 7,243 | 🐛 7 | 📅 2026-08-13 - This list is for anyone wishing to learn about web application security but do not have a starting point.
* [Awesome Threat Detection and Hunting](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,709 | 🐛 54 | 📅 2026-01-05 - A curated list of awesome threat detection and hunting resources.

...
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 30,313 | 🐛 34 | 📅 2026-07-13 - for a single Linux server at home
...
* [VPS Security Audit Script](https://github.com/vernu/vps-audit) ⭐ 2,541 | 🐛 10 | 🌐 Shell | 📅 2026-08-10 - A comprehensive Bash script for auditing the security and performance of your VPS (Virtual Private Server)
...
* [testssl.sh](https://github.com/drwetter/testssl.sh) ⭐ 9,180 | 🐛 248 | 🌐 Shell | 📅 2026-08-24 - Testing TLS/SSL encryption anywhere on any port
...
* [CHIPSEC: Platform Security Assessment Framework](https://github.com/chipsec/chipsec) ⭐ 3,295 | 🐛 46 | 🌐 Python | 📅 2026-08-25 - framework for analyzing the security of PC platforms including hardware, system firmware (BIOS/UEFI), and platform components
...
* [Awesome Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,541 | 🐛 75 | 📅 2024-07-15 - A curated collection of awesome resources, tools, and other shiny things for cybersecurity blue teams.

## Other Awesome Security Lists

(borrowed from [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,795 | 🐛 315 | 📅 2026-01-11)
...
* [Awesome CTF](https://github.com/apsdehal/awesome-ctf) ⭐ 11,797 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22 - A curated list of CTF frameworks, libraries, resources and software.
* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,575 | 🐛 118 | 📅 2026-05-31 - A curated list of threat intelligence resources.
...
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,352 | 🐛 75 | 📅 2026-07-15 - A curated list of resources for incident response.
...
* [Awesome Threat Detection and Hunting](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,710 | 🐛 53 | 📅 2026-01-05 - A curated list of awesome threat detection and hunting resources.
...
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,261 | 🐛 1 | 📅 2026-06-15 - A curated list of awesome YARA rules, tools, and people.

...
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 30,309 | 🐛 34 | 📅 2026-07-13 - for a single Linux server at home
...
* [Neo23x0/auditd](https://github.com/Neo23x0/auditd) ⭐ 1,897 | 🐛 18 | 🌐 Shell | 📅 2026-05-04 - Best Practice Auditd Configuration
...
* [CIS Debian Hardening](https://github.com/ovh/debian-cis) ⭐ 1,056 | 🐛 17 | 🌐 Shell | 📅 2026-08-21 - Modular Debian 11/12/13 security hardening scripts based on [CIS Benchmarks](https://www.cisecurity.org/cis-benchmarks/) recommendations.
...
* [SSLyze](https://github.com/nabla-c0d3/sslyze) ⭐ 3,775 | 🐛 30 | 🌐 Python | 📅 2026-08-23 - Fast and powerful SSL/TLS scanning library.
...
* [Awesome Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,539 | 🐛 76 | 📅 2024-07-15 - A curated collection of awesome resources, tools, and other shiny things for cybersecurity blue teams.

## Other Awesome Security Lists

(borrowed from [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,791 | 🐛 313 | 📅 2026-01-11)
...
* [Awesome CTF](https://github.com/apsdehal/awesome-ctf) ⭐ 11,791 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22 - A curated list of CTF frameworks, libraries, resources and software.
* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,568 | 🐛 119 | 📅 2026-05-31 - A curated list of threat intelligence resources.
...
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,349 | 🐛 74 | 📅 2026-07-15 - A curated list of resources for incident response.
...
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,260 | 🐛 1 | 📅 2026-06-15 - A curated list of awesome YARA rules, tools, and people.

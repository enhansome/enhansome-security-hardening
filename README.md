...
* [trimstray - The Practical Linux Hardening Guide](https://github.com/trimstray/the-practical-linux-hardening-guide) ⭐ 10,809 | 🐛 10 | 📅 2024-11-19 - practical step-by-step instructions for building your own hardened systems and services. Tested on CentOS 7 and RHEL 7.
* [Neo23x0/auditd](https://github.com/Neo23x0/auditd) ⭐ 1,887 | 🐛 18 | 🌐 Shell | 📅 2026-05-04 - Best Practice Auditd Configuration
...
* [Qualys SSL Labs - SSL and TLS Deployment Best Practices](https://github.com/ssllabs/research/wiki/SSL-and-TLS-Deployment-Best-Practices) ⭐ 2,207 | 🐛 2 | 📅 2023-03-14 - 2017, does not cover TLS 1.3
...
* [VPS Security Audit Script](https://github.com/vernu/vps-audit) ⭐ 2,482 | 🐛 10 | 🌐 Shell | 📅 2026-08-10 - A comprehensive Bash script for auditing the security and performance of your VPS (Virtual Private Server)
* [SUDO\_KILLER](https://github.com/TH3xACE/SUDO_KILLER) ⭐ 2,479 | 🐛 1 | 🌐 Shell | 📅 2026-03-11 - A tool to identify sudo rules' misconfigurations and vulnerabilities within sudo
* [CIS Debian Hardening](https://github.com/ovh/debian-cis) ⭐ 1,049 | 🐛 14 | 🌐 Shell | 📅 2026-08-13 - Modular Debian 11/12/13 security hardening scripts based on [CIS Benchmarks](https://www.cisecurity.org/cis-benchmarks/) recommendations.
...
* [testssl.sh](https://github.com/drwetter/testssl.sh) ⭐ 9,162 | 🐛 249 | 🌐 Shell | 📅 2026-08-12 - Testing TLS/SSL encryption anywhere on any port
...
* [Awesome Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,511 | 🐛 74 | 📅 2024-07-15 - A curated collection of awesome resources, tools, and other shiny things for cybersecurity blue teams.

## Other Awesome Security Lists

(borrowed from [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,747 | 🐛 302 | 📅 2026-01-11)

* [Awesome Pentest](https://github.com/enaqx/awesome-pentest) ⭐ 26,891 | 🐛 98 | 📅 2026-07-25 - A collection of awesome penetration testing resources, tools and other shiny things.
* [Awesome Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 16,861 | 🐛 68 | 📅 2024-06-02 - A curated list of awesome Hacking tutorials, tools and resources.
...
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,114 | 🐛 25 | 📅 2024-06-07 - A curated list of awesome malware analysis tools and resources.
* [Awesome CTF](https://github.com/apsdehal/awesome-ctf) ⭐ 11,753 | 🐛 64 | 🌐 JavaScript | 📅 2024-07-22 - A curated list of CTF frameworks, libraries, resources and software.
* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,530 | 🐛 115 | 📅 2026-05-31 - A curated list of threat intelligence resources.
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,519 | 🐛 21 | 🌐 Python | 📅 2026-06-01 - An awesome list of honeypot resources.
...
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,322 | 🐛 73 | 📅 2026-07-15 - A curated list of resources for incident response.
...
* [Awesome Threat Detection and Hunting](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,701 | 🐛 53 | 📅 2026-01-05 - A curated list of awesome threat detection and hunting resources.
...
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,254 | 🐛 1 | 📅 2026-06-15 - A curated list of awesome YARA rules, tools, and people.

...
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 30,318 | 🐛 35 | 📅 2026-07-13 - for a single Linux server at home
* [trimstray - The Practical Linux Hardening Guide](https://github.com/trimstray/the-practical-linux-hardening-guide) ⭐ 10,820 | 🐛 10 | 📅 2024-11-19 - practical step-by-step instructions for building your own hardened systems and services. Tested on CentOS 7 and RHEL 7.
* [Neo23x0/auditd](https://github.com/Neo23x0/auditd) ⭐ 1,899 | 🐛 18 | 🌐 Shell | 📅 2026-05-04 - Best Practice Auditd Configuration
* [trimstray - Linux Hardening Checklist](https://github.com/trimstray/linux-hardening-checklist) ⭐ 1,642 | 🐛 5 | 📅 2024-11-19 - most important hardening rules for GNU/Linux systems (summarized version of The Practical Linux Hardening Guide)
...
* [Awesome Windows Domain Hardening](https://github.com/PaulSec/awesome-windows-domain-hardening) ⭐ 1,798 | 🐛 1 | 📅 2020-01-07
...
* [Qualys SSL Labs - SSL and TLS Deployment Best Practices](https://github.com/ssllabs/research/wiki/SSL-and-TLS-Deployment-Best-Practices) ⭐ 2,205 | 🐛 2 | 📅 2023-03-14 - 2017, does not cover TLS 1.3
...
* [VPS Security Audit Script](https://github.com/vernu/vps-audit) ⭐ 2,768 | 🐛 11 | 🌐 Shell | 📅 2026-08-10 - A comprehensive Bash script for auditing the security and performance of your VPS (Virtual Private Server)
...
* [CIS Debian Hardening](https://github.com/ovh/debian-cis) ⭐ 1,057 | 🐛 17 | 🌐 Shell | 📅 2026-08-21 - Modular Debian 11/12/13 security hardening scripts based on [CIS Benchmarks](https://www.cisecurity.org/cis-benchmarks/) recommendations.
...
* [testssl.sh](https://github.com/drwetter/testssl.sh) ⭐ 9,181 | 🐛 248 | 🌐 Shell | 📅 2026-08-24 - Testing TLS/SSL encryption anywhere on any port
* [SSLyze](https://github.com/nabla-c0d3/sslyze) ⭐ 3,775 | 🐛 31 | 🌐 Python | 📅 2026-08-23 - Fast and powerful SSL/TLS scanning library.
* [Qualys SSL Labs - List of tools to assess TLS/SSL servers and clients](https://github.com/ssllabs/research/wiki/Assessment-Tools) ⭐ 2,205 | 🐛 2 | 📅 2023-03-14
...
* [CHIPSEC: Platform Security Assessment Framework](https://github.com/chipsec/chipsec) ⭐ 3,295 | 🐛 44 | 🌐 Python | 📅 2026-08-26 - framework for analyzing the security of PC platforms including hardware, system firmware (BIOS/UEFI), and platform components
...
* [Docker Bench for Security](https://github.com/docker/docker-bench-security) ⭐ 9,693 | 🐛 29 | 🌐 Shell | 📅 2026-06-04 - script that checks for dozens of common best-practices around deploying Docker containers in production, inspired by the CIS Docker Community Edition Benchmark v1.1.0.

### Cloud

* [toniblyx/my-arsenal-of-aws-security-tools](https://github.com/toniblyx/my-arsenal-of-aws-security-tools) ⭐ 9,502 | 🐛 10 | 🌐 Shell | 📅 2026-07-07 - List of open source tools for AWS security: defensive, offensive, auditing, DFIR, etc.
...
* [Awesome Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,542 | 🐛 75 | 📅 2024-07-15 - A curated collection of awesome resources, tools, and other shiny things for cybersecurity blue teams.

## Other Awesome Security Lists

(borrowed from [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,799 | 🐛 313 | 📅 2026-01-11)

* [Awesome Pentest](https://github.com/enaqx/awesome-pentest) ⭐ 27,025 | 🐛 104 | 📅 2026-07-25 - A collection of awesome penetration testing resources, tools and other shiny things.
* [Awesome Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 16,950 | 🐛 69 | 📅 2024-06-02 - A curated list of awesome Hacking tutorials, tools and resources.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,799 | 🐛 313 | 📅 2026-01-11 - A collection of awesome software, libraries, documents, books, resources and cools stuffs about security.
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,159 | 🐛 25 | 📅 2024-06-07 - A curated list of awesome malware analysis tools and resources.
* [Awesome CTF](https://github.com/apsdehal/awesome-ctf) ⭐ 11,800 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22 - A curated list of CTF frameworks, libraries, resources and software.
* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,580 | 🐛 116 | 📅 2026-05-31 - A curated list of threat intelligence resources.
...
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,353 | 🐛 75 | 📅 2026-07-15 - A curated list of resources for incident response.
...
* [Awesome Threat Detection and Hunting](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,711 | 🐛 53 | 📅 2026-01-05 - A curated list of awesome threat detection and hunting resources.
* [Awesome Cyber Skills](https://github.com/joe-shenouda/awesome-cyber-skills) ⭐ 4,639 | 🐛 8 | 📅 2024-07-02 - A curated list of hacking environments where you can train your cyber skills legally and safely.
...
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,263 | 🐛 1 | 📅 2026-06-15 - A curated list of awesome YARA rules, tools, and people.
* [Awesome PCAP Tools](https://github.com/caesar0301/awesome-pcaptools) ⭐ 3,415 | 🐛 14 | 📅 2025-09-03 - A collection of tools developed by other researchers in the Computer Science area to process network traces.

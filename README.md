...
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 30,308 | 🐛 34 | 📅 2026-07-13 - for a single Linux server at home
* [trimstray - The Practical Linux Hardening Guide](https://github.com/trimstray/the-practical-linux-hardening-guide) ⭐ 10,818 | 🐛 10 | 📅 2024-11-19 - practical step-by-step instructions for building your own hardened systems and services. Tested on CentOS 7 and RHEL 7.
* [Neo23x0/auditd](https://github.com/Neo23x0/auditd) ⭐ 1,896 | 🐛 18 | 🌐 Shell | 📅 2026-05-04 - Best Practice Auditd Configuration
...
* [NSA - Hardware and Firmware Security Guidance](https://github.com/nsacyber/Hardware-and-Firmware-Security-Guidance) ⭐ 874 | 🐛 12 | 🌐 C | 📅 2024-12-23 - Guidance for the Spectre, Meltdown, Speculative Store Bypass, Rogue System Register Read, Lazy FP State Restore, Bounds Check Bypass Store, TLBleed, and L1TF/Foreshadow vulnerabilities as well as general hardware and firmware security guidance.
...
* [VPS Security Audit Script](https://github.com/vernu/vps-audit) ⭐ 2,542 | 🐛 10 | 🌐 Shell | 📅 2026-08-10 - A comprehensive Bash script for auditing the security and performance of your VPS (Virtual Private Server)
...
* [CIS Debian Hardening](https://github.com/ovh/debian-cis) ⭐ 1,055 | 🐛 17 | 🌐 Shell | 📅 2026-08-21 - Modular Debian 11/12/13 security hardening scripts based on [CIS Benchmarks](https://www.cisecurity.org/cis-benchmarks/) recommendations.
...
* [testssl.sh](https://github.com/drwetter/testssl.sh) ⭐ 9,180 | 🐛 252 | 🌐 Shell | 📅 2026-08-15 - Testing TLS/SSL encryption anywhere on any port
* [SSLyze](https://github.com/nabla-c0d3/sslyze) ⭐ 3,774 | 🐛 30 | 🌐 Python | 📅 2026-08-23 - Fast and powerful SSL/TLS scanning library.
...
* [CHIPSEC: Platform Security Assessment Framework](https://github.com/chipsec/chipsec) ⭐ 3,294 | 🐛 52 | 🌐 Python | 📅 2026-08-24 - framework for analyzing the security of PC platforms including hardware, system firmware (BIOS/UEFI), and platform components
...
* [Docker Bench for Security](https://github.com/docker/docker-bench-security) ⭐ 9,694 | 🐛 29 | 🌐 Shell | 📅 2026-06-04 - script that checks for dozens of common best-practices around deploying Docker containers in production, inspired by the CIS Docker Community Edition Benchmark v1.1.0.

### Cloud

* [toniblyx/my-arsenal-of-aws-security-tools](https://github.com/toniblyx/my-arsenal-of-aws-security-tools) ⭐ 9,501 | 🐛 10 | 🌐 Shell | 📅 2026-07-07 - List of open source tools for AWS security: defensive, offensive, auditing, DFIR, etc.
...
* [Awesome Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,536 | 🐛 76 | 📅 2024-07-15 - A curated collection of awesome resources, tools, and other shiny things for cybersecurity blue teams.

## Other Awesome Security Lists

(borrowed from [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,790 | 🐛 313 | 📅 2026-01-11)

* [Awesome Pentest](https://github.com/enaqx/awesome-pentest) ⭐ 26,995 | 🐛 103 | 📅 2026-07-25 - A collection of awesome penetration testing resources, tools and other shiny things.
...
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,151 | 🐛 25 | 📅 2024-06-07 - A curated list of awesome malware analysis tools and resources.
* [Awesome CTF](https://github.com/apsdehal/awesome-ctf) ⭐ 11,789 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22 - A curated list of CTF frameworks, libraries, resources and software.
* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,564 | 🐛 118 | 📅 2026-05-31 - A curated list of threat intelligence resources.
...
* [Android Security Awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,634 | 🐛 0 | 🌐 Makefile | 📅 2026-08-21 - A collection of android security related resources.
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,348 | 🐛 74 | 📅 2026-07-15 - A curated list of resources for incident response.
* [Awesome Web Hacking](https://github.com/infoslack/awesome-web-hacking) ⭐ 7,244 | 🐛 7 | 📅 2026-08-13 - This list is for anyone wishing to learn about web application security but do not have a starting point.
* [Awesome Threat Detection and Hunting](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,710 | 🐛 54 | 📅 2026-01-05 - A curated list of awesome threat detection and hunting resources.
...
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,259 | 🐛 1 | 📅 2026-06-15 - A curated list of awesome YARA rules, tools, and people.

...
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 30,911 | 🐛 36 | 📅 2026-07-13 - for a single Linux server at home
* [trimstray - The Practical Linux Hardening Guide](https://github.com/trimstray/the-practical-linux-hardening-guide) ⭐ 10,822 | 🐛 10 | 📅 2024-11-19 - practical step-by-step instructions for building your own hardened systems and services. Tested on CentOS 7 and RHEL 7.
* [Neo23x0/auditd](https://github.com/Neo23x0/auditd) ⭐ 1,903 | 🐛 18 | 🌐 Shell | 📅 2026-05-04 - Best Practice Auditd Configuration
...
* [VPS Security Audit Script](https://github.com/vernu/vps-audit) ⭐ 2,870 | 🐛 11 | 🌐 Shell | 📅 2026-08-10 - A comprehensive Bash script for auditing the security and performance of your VPS (Virtual Private Server)
...
* [testssl.sh](https://github.com/drwetter/testssl.sh) ⭐ 9,185 | 🐛 245 | 🌐 Shell | 📅 2026-08-31 - Testing TLS/SSL encryption anywhere on any port
...
* [CHIPSEC: Platform Security Assessment Framework](https://github.com/chipsec/chipsec) ⭐ 3,297 | 🐛 47 | 🌐 Python | 📅 2026-08-31 - framework for analyzing the security of PC platforms including hardware, system firmware (BIOS/UEFI), and platform components
...
* [Awesome Cybersecurity Blue Team](https://github.com/fabacab/awesome-cybersecurity-blueteam) ⭐ 5,550 | 🐛 78 | 📅 2024-07-15 - A curated collection of awesome resources, tools, and other shiny things for cybersecurity blue teams.

## Other Awesome Security Lists

(borrowed from [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,814 | 🐛 320 | 📅 2026-01-11)

* [Awesome Pentest](https://github.com/enaqx/awesome-pentest) ⭐ 27,074 | 🐛 107 | 📅 2026-07-25 - A collection of awesome penetration testing resources, tools and other shiny things.
* [Awesome Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 16,976 | 🐛 70 | 📅 2024-06-02 - A curated list of awesome Hacking tutorials, tools and resources.
* [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,814 | 🐛 320 | 📅 2026-01-11 - A collection of awesome software, libraries, documents, books, resources and cools stuffs about security.
* [Awesome Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,169 | 🐛 25 | 📅 2024-06-07 - A curated list of awesome malware analysis tools and resources.
* [Awesome CTF](https://github.com/apsdehal/awesome-ctf) ⭐ 11,812 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22 - A curated list of CTF frameworks, libraries, resources and software.
* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,583 | 🐛 117 | 📅 2026-05-31 - A curated list of threat intelligence resources.
* [Awesome Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,539 | 🐛 23 | 🌐 Python | 📅 2026-06-01 - An awesome list of honeypot resources.
...
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,363 | 🐛 76 | 📅 2026-07-15 - A curated list of resources for incident response.
* [Awesome Web Hacking](https://github.com/infoslack/awesome-web-hacking) ⭐ 7,251 | 🐛 8 | 📅 2026-08-13 - This list is for anyone wishing to learn about web application security but do not have a starting point.
* [Awesome Threat Detection and Hunting](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,715 | 🐛 54 | 📅 2026-01-05 - A curated list of awesome threat detection and hunting resources.
* [Awesome Cyber Skills](https://github.com/joe-shenouda/awesome-cyber-skills) ⭐ 4,647 | 🐛 8 | 📅 2024-07-02 - A curated list of hacking environments where you can train your cyber skills legally and safely.
...
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,264 | 🐛 2 | 📅 2026-06-15 - A curated list of awesome YARA rules, tools, and people.
* [Awesome PCAP Tools](https://github.com/caesar0301/awesome-pcaptools) ⭐ 3,417 | 🐛 14 | 📅 2025-09-03 - A collection of tools developed by other researchers in the Computer Science area to process network traces.

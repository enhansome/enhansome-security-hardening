...
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 31,107 | 🐛 36 | 📅 2026-07-13 - for a single Linux server at home
...
* [Neo23x0/auditd](https://github.com/Neo23x0/auditd) ⭐ 1,904 | 🐛 18 | 🌐 Shell | 📅 2026-05-04 - Best Practice Auditd Configuration
...
* [VPS Security Audit Script](https://github.com/vernu/vps-audit) ⭐ 2,919 | 🐛 11 | 🌐 Shell | 📅 2026-08-10 - A comprehensive Bash script for auditing the security and performance of your VPS (Virtual Private Server)
...
* [CIS Debian Hardening](https://github.com/ovh/debian-cis) ⭐ 1,059 | 🐛 16 | 🌐 Shell | 📅 2026-09-02 - Modular Debian 11/12/13 security hardening scripts based on [CIS Benchmarks](https://www.cisecurity.org/cis-benchmarks/) recommendations.
...
* [testssl.sh](https://github.com/drwetter/testssl.sh) ⭐ 9,187 | 🐛 245 | 🌐 Shell | 📅 2026-09-01 - Testing TLS/SSL encryption anywhere on any port
...
* [CHIPSEC: Platform Security Assessment Framework](https://github.com/chipsec/chipsec) ⭐ 3,298 | 🐛 52 | 🌐 Python | 📅 2026-09-02 - framework for analyzing the security of PC platforms including hardware, system firmware (BIOS/UEFI), and platform components
...
(borrowed from [Awesome Security](https://github.com/sbilly/awesome-security) ⭐ 14,821 | 🐛 321 | 📅 2026-01-11)

* [Awesome Pentest](https://github.com/enaqx/awesome-pentest) ⭐ 27,096 | 🐛 110 | 📅 2026-07-25 - A collection of awesome penetration testing resources, tools and other shiny things.
...
* [Awesome CTF](https://github.com/apsdehal/awesome-ctf) ⭐ 11,819 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22 - A curated list of CTF frameworks, libraries, resources and software.
* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,588 | 🐛 118 | 📅 2026-05-31 - A curated list of threat intelligence resources.
...
* [Android Security Awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,667 | 🐛 0 | 🌐 Makefile | 📅 2026-08-21 - A collection of android security related resources.
* [Awesome Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,369 | 🐛 76 | 📅 2026-07-15 - A curated list of resources for incident response.
...
* [Awesome YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,268 | 🐛 2 | 📅 2026-06-15 - A curated list of awesome YARA rules, tools, and people.
